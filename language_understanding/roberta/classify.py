...
def main(idx=5,
    ...
    task_to_keys = {
        "cola": ("sentence", None),#mcc-8,551 cross
        "mnli": ("premise", "hypothesis"),#392,702 cross
        "mrpc": ("sentence1", "sentence2"),#3,668 cross
        "qnli": ("question", "sentence"),#104,743 cross
    ...
    tokenizer = RobertaTokenizer.from_pretrained('ckp/tokenizer')
    num_labels = 3 if task.startswith("mnli") else 1 if task=="stsb" else 2
    model = RobertaForSequenceClassification.from_pretrained('ckp/models--roberta-base/snapshots/bc2764f8af2e92b6eb5679868df33e224075ca68', num_labels=num_labels).to('cuda:0')
    ...
    # elif mode == 'eval':
        ...
        model_file_save = f"save_rd/{file_id}_{current_timestamp}"
